...
const KyugyoPage = (props) => {
    ...
    const isMissingKyugyoInfo = (kyugyo) => {
        const isMissingKyugyoParam = kyugyo.access && kyugyo.storeName && kyugyo.hpUrl && kyugyo.address;
        return isMissingKyugyoParam;
    }

    return (
        <div className='text-center'>
            {!isMissingKyugyoInfo(kyugyo) && (
                <div className='bg-danger text-white'>欠損情報あり</div>
            )}
            <h2 className="text-white">店舗情報</h2>
            {(kyugyo !== undefined && !isUpdating) && (
                <>
                    <div className="flex-fill text-white kg-font-size ml-0 ml-sm-4">
                        ...
                        <div className="border-bottom border-white mb-3 py-4 px-5">店名：{kyugyo.storeName}</div>
                        <div className="border-bottom border-white mb-3 py-4 px-5">住所：{kyugyo.address}</div>
                        <div className="border-bottom border-white mb-3 py-4 px-5">
                            アクセス：{kyugyo.access}
                        </div>
                        <div className="border-bottom border-white mb-3 py-4 px-5">
                            <h3>店舗URL</h3>
                        ...
                        <div className="kg-misc-box border-bottom border-white mb-3 pt-4 pb-5 px-5">
                            <h3>備考</h3>
                            {kyugyo.misc}
                        </div>
                        <div className="border-bottom border-white py-4 px-5">
